...
function controlPageHtml() {
  return `<!doctype html><html lang="id"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>GemBot Control</title><style>${appShellStyles()}
    ...
    <section class="tabPanel"><div id="pane-expr" class="pane active"><h2 class="title">Kontrol Ekspresi</h2><p class="subtitle">Pilih mood GemBot secara langsung.</p><div class="gridExpr"><button class="exprBtn" data-cmd="M0"><span class="big">●‿●</span><small>Senyum</small></button><button class="exprBtn" data-cmd="M1"><span class="big">⌒▽⌒</span><small>Senang</small></button><button class="exprBtn" data-cmd="M50"><span class="big">♥‿♥</span><small>Love</small></button><button class="exprBtn" data-cmd="M35"><span class="big">✪‿✪</span><small>Berbinar</small></button><button class="exprBtn" data-cmd="M51"><span class="big">＞▽＜</span><small>Ketawa</small></button><button class="exprBtn" data-cmd="M33"><span class="big">⌐■_■</span><small>Keren</small></button><button class="exprBtn" data-cmd="M32"><span class="big">¬_¬</span><small>Curiga</small></button><button class="exprBtn" data-cmd="M31"><span class="big">—‿●</span><small>Nakal</small></button><button class="exprBtn" data-cmd="M4"><span class="big">OｏO</span><small>Kaget</small></button><button class="exprBtn" data-cmd="M28"><span class="big">O▽O</span><small>Amazed</small></button><button class="exprBtn" data-cmd="M5"><span class="big">—‿—</span><small>Ngantuk</small></button><button class="exprBtn" data-cmd="M6"><span class="big">●︵●</span><small>Sedih</small></button><button class="exprBtn" data-cmd="M29"><span class="big">╥︵╥</span><small>Nangis</small></button><button class="exprBtn" data-cmd="M3"><span class="big">◣︵◢</span><small>Marah</small></button><button class="exprBtn" data-cmd="M27"><span class="big">¬︵¬</span><small>Grumpy</small></button><button class="exprBtn" data-cmd="M30"><span class="big">@﹏@</span><small>Pusing</small></button><button class="exprBtn" data-cmd="M34"><span class="big">↻_↺</span><small>Loading</small></button><button class="exprBtn" data-cmd="M25"><span class="big">●﹏●</span><small>Guilty</small></button><button class="exprBtn" data-cmd="M26"><span class="big">◔‿◔</span><small>Daydream</small></button></div></div>
